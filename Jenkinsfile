                    ...
                    steps {
                        script {
                            docker.withRegistry('', 'ee2e2ea7-2ab9-4672-8ecd-e3a149bdbccb') {
                                ...
                                docker.image("hiruniwijendrasinhe/alertfy_frontend:${env.BUILD_NUMBER}").tag("latest")
                    ...
                    steps {
                        script {
                            docker.withRegistry('', 'ee2e2ea7-2ab9-4672-8ecd-e3a149bdbccb') {
                                ...
                                docker.image("hiruniwijendrasinhe/alertfy_backend:${env.BUILD_NUMBER}").tag("latest")
